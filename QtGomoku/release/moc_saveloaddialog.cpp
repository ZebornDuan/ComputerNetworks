...
struct qt_meta_stringdata_saveLoadDialog_t {
    QByteArrayData data[1];
    char stringdata[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_saveLoadDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_saveLoadDialog_t qt_meta_stringdata_saveLoadDialog = {
    {
QT_MOC_LITERAL(0, 0, 14) // "saveLoadDialog"
...
const QMetaObject saveLoadDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_saveLoadDialog.data,
      qt_meta_data_saveLoadDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *saveLoadDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_saveLoadDialog.stringdata))
