...
QT_MOC_LITERAL(1, 10, 8), // "addChess"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 9), // "chessInfo"
QT_MOC_LITERAL(4, 30, 3), // "win"
QT_MOC_LITERAL(5, 34, 15), // "enemyChessAdded"
QT_MOC_LITERAL(6, 50, 3), // "row"
QT_MOC_LITERAL(7, 54, 3), // "col"
QT_MOC_LITERAL(8, 58, 7), // "onStart"
QT_MOC_LITERAL(9, 66, 9), // "onTimeout"
QT_MOC_LITERAL(10, 76, 6), // "onUndo"
QT_MOC_LITERAL(11, 83, 6), // "onLoad"
QT_MOC_LITERAL(12, 90, 2), // "id"
QT_MOC_LITERAL(13, 93, 8) // "isDanger"

    },
    "GameBoard\0addChess\0\0chessInfo\0win\0"
    "enemyChessAdded\0row\0col\0onStart\0"
    "onTimeout\0onUndo\0onLoad\0id\0isDanger"
};
...
void GameBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->addChess((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->win(); break;
        case 2: _t->enemyChessAdded((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 3: _t->onStart(); break;
        case 4: _t->onTimeout(); break;
        case 5: _t->onUndo(); break;
        case 6: _t->onLoad((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 7: _t->isDanger(); break;
        default: ;
        }
        ...
        {
            typedef void (GameBoard::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameBoard::addChess)) {
                *result = 0;
            }
        }
        {
            typedef void (GameBoard::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameBoard::win)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void GameBoard::addChess(QString _t1)
{
